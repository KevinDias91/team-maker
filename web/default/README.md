...
This app gives you the opportunity to create balanced basketball teams.

You can add the players you want (like friends of your) with their features (only 3 features per player).
